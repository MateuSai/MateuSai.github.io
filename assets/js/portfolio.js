...
Portfolio.switchToGame = function(game) {
	...
	if(Portfolio.activeGame == Game.PLACEHOLDER) {
		window.document.getElementById("game-placeholder").remove();
	} else if(Portfolio.activeGame == Game.GAME_0) {
		window.document.getElementById("game_0").remove();
	} else if(Portfolio.activeGame == Game.GAME_1) {
		window.document.getElementById("game_1").remove();
	}
